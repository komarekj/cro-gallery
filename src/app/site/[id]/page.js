      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-xl">
          <div className="flex flex-col md:flex-row">
            {/* Left column - Image */}
            <div className="relative h-80 md:h-auto md:w-2/5 md:min-h-[500px]">
              <div className="absolute inset-0 bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                <span className="text-2xl text-gray-500 dark:text-gray-400">{store.domain}</span>
              </div>
              {store.imageUrl && (
                <Image
                  src={store.imageUrl}
            ...
            <div className="p-8 md:w-3/5">
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-8">{store.metadata?.description || store.description}</p>
                  ...
                  {store.analysis && store.analysis.content ? (
                    ...
                    <div className="space-y-8">
                      {store.metadata.analysis.persona && (
                        <div>
                          <h3 className="text-xl font-bold text-blue-600 dark:text-blue-400 mb-2">Target Persona</h3>
                      ...
                      {store.metadata.analysis.benefits?.length > 0 && (
                        <div>
                          <h3 className="text-xl font-bold text-blue-600 dark:text-blue-400 mb-2">Key Benefits</h3>
                          <div className="grid md:grid-cols-2 gap-4">
                            {store.metadata.analysis.benefits.filter(b => b.included).map((benefit, index) => (
                              <div key={index} className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
                                ...
                                <div className="mt-3 bg-gray-100/80 dark:bg-gray-800/30 border-l-2 border-gray-400 dark:border-gray-600 p-3 rounded-r-lg flex items-start">
                      ...
                      {store.metadata.analysis.differentiators?.length > 0 && (
                        <div>
                          <h3 className="text-xl font-bold text-blue-600 dark:text-blue-400 mb-2">Unique Differentiators</h3>
                          <div className="grid md:grid-cols-2 gap-4">
                      ...
                      {store.metadata.analysis.objections?.length > 0 && (
                        <div>
                          <h3 className="text-xl font-bold text-blue-600 dark:text-blue-400 mb-2">Common Objections</h3>
                          <div className="grid md:grid-cols-2 gap-4">
                      ...
                      {store.metadata.analysis.trust?.length > 0 && (
                        <div>
                          <h3 className="text-xl font-bold text-blue-600 dark:text-blue-400 mb-2">Trust Elements</h3>
                          <div className="grid md:grid-cols-2 gap-4">
                      ...
                      {store.metadata.analysis.urgency?.length > 0 && (
                        <div>
                          <h3 className="text-xl font-bold text-blue-600 dark:text-blue-400 mb-2">Urgency Elements</h3>
                          <div className="grid md:grid-cols-2 gap-4">
                      ...
                      {store.metadata.analysis.crosssell?.length > 0 && (
                        <div>
                          <h3 className="text-xl font-bold text-blue-600 dark:text-blue-400 mb-2">Cross-Sell Opportunities</h3>
                          <div className="grid md:grid-cols-2 gap-4">
